...
public class MapActivity extends AppCompatActivity implements PermissionsListener {
    ...
    private final String symbolIconId = "700142";
    private static final int REQUEST_CODE_AUTOCOMPLETE = 1;
    private final String geojsonSourceLayerId = "101024";
    @Override
            ...
            mapBoxMap.getStyle(new Style.OnStyleLoaded() {
                ...
                public void onStyleLoaded(@NonNull Style style) {
                    ...
                    style.addImage(symbolIconId, BitmapFactory.decodeResource(
                            MapActivity.this.getResources(), R.drawable.map_default_map_marker));
                }
            });
        } else {
